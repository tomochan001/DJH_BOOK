...
OECD生徒の学習到達度調査（PISA）プロジェクト The http://bit.ly/Pisa_Wealth[PISA based Wealth Comparison] は、各国の生活水準を比較できるインタラクティブ・ビジュアライゼーションである。このプロジェクトは、2010年12月に出版されたOECDの包括的な世界の教育ランキングレポートのデータを使っている。 http://bit.ly/Pisa_2009[PISA 2009]　このレポートは、14歳の生徒を対象に実施された、生活状況についてのアンケート調査に基づいている。
...
次に、プロジェクトを助けることができる開発者を見つけるためにドイツの人々 http://opendata-network.org/[Open Data Network] に連絡を取った。非常に意欲的な人々が集まるこのコミュニティは、私たちの夢を叶える事ができるであろうアプリケーションのコードが書ける（しかも私たちにとって極めて重要だったフラッシュを使わずに！）非常に才能のある情報デザイナー、Gregor Aischを薦めてくれた。Gregorは http://raphaeljs.com/[ラファエル·Javascriptのライブラリ] に基づいて、美しいバブルスタイルで非常に高品質でインタラクティブなビジュアライゼーションを作成した。
